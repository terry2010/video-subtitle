...
def parse_arguments():
    ...
    translate_parser.add_argument('--translate-model', type=str, required=True, help='翻译模型名字')
    ...
    translate_from_audio_parser.add_argument('--translate-model', type=str, required=True, help='翻译模型名字')
